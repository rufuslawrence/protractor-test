...
exports.getCurrentDateWithSeconds = function () {
    var currentDate = new Date();
    return (currentDate.getMonth() + currentDate.getDate() + (currentDate.getYear()+1900) + currentDate.getHours() + currentDate.getMinutes() + currentDate.getSeconds());
};
